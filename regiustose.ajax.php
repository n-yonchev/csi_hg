<?php
# вика се само с jQuery.ajax - regiustose.tpl 
...
putcases("iduser=$iduser","suitstathist.iduser=$iduser");
putpersons("suit.iduser=$iduser");
putorigins("suit.iduser=$iduser");
putzip();
#-----------------------------------------
*/
#-----------------------------------------
$coderegiuser= $_SESSION["coderegiuser"];
//putcases("iduser".$coderegiuser, "suitstathist.iduser".$coderegiuser);
putcases("iduser".$coderegiuser, "suit.iduser".$coderegiuser);
putpersons("suit.iduser".$coderegiuser);
putorigins("suit.iduser".$coderegiuser);
putzip();
#-----------------------------------------
...
*****/
			...
			regiexec($serial, $namezi, $uniqname);
...
*/
		file_put_contents($fnpref.".txt",$tsec);
print $resu;
				}else{
print "wait^$tsec";
				}

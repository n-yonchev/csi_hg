<?php
# търсене на вх.документ по година - избора и списъка заедно 
...
//print_r($GETPARAM);
									...
									$view= $GETPARAM["view"];
									if (isset($view)){
$filter= "docu.year=$view";
$smarty->assign("FILTTX", "за година $view");
...
$mylist= $DB->select("select year as ARRAY_KEY, count(*) as coun from docu group by year");
...
$pagecont= smdisp("fdyeform.tpl","fetch");

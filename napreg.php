...
$TABLNAME= "regionnap";
$HEADMAIN= "клоновете на НАП";
$HEADEDIT= "клон на НАП";
...
$iduser= @$_SESSION["iduser"];
									...
									$edit= $GETPARAM["edit"];
									if (isset($edit)){
										include_once "napregedit.ajax.php";
										exit;
									}else{
									}
									...
									$dele= $GETPARAM["dele"];
									if (isset($dele)){
										include_once "napregdele.ajax.php";
										exit;
									}else{
									}
...
# списъка 
$mylist= $DB->select("select * from regionnap order by id");
...
$pagecont= smdisp("napreg.tpl","fetch");
*/

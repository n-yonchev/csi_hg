<?php
# разпределение : сметката като бюджетна или не 
# отгоре : 
...
# основен : 
#    $accobudg - finatran.id за сметката 
# още отгоре : 
...
//print "MFACPROC=[$mfacproc]";
									# основен параметър - 
									# $accobudg = finatran.id 
									# $iban = finatran.iban = tranacco.iban 
if (0){

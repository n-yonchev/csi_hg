<?php
# 06.05.2009 - ПКО - ръчно добавяне/корекция на записи 
# отгоре : 
...
$prihnumb= $rocont["cashserial"]."/".$rocont["cashyear"];
$smarty->assign("PRIHNUMB", $prihnumb);
...
#------ submit без формални грешки 
							...
							$retucode= 0;
													# заключваме 
													$DB->query("lock tables $taname write, suit write, finance write, claimadva write");

...
//print "<h2>$daysrest</h2>";
	...
	$page= 1;
# ВАЖНО 
$rel6= geturl("mode=".$mode."&vari=".$vari);
reload("",$rel6);
}else{
}
...
# бройка дела 
$qucoun= "select count(*) from ($q4coun) as t4";
$coun0= $DB->selectCell($qucoun);
//$smarty->assign("COUN0", $coun0);
...
$query= "
	...
	order by diff desc, t4.idcase desc
	";
//	order by t4.idcase desc
...
$pagecont= smdisp("pere0_2.tpl","fetch");

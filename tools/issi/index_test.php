...
// Взимат се датаите с неуспешни завки и към тях се добавя дата за новата заявка.
// $missed_dates = IssiLog::getMissedDates();
// $missed_dates[] = $new_date;

// foreach($missed_dates as $date) {
    // Изходящи

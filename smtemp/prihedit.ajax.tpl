...
{if $EDIT==0}
	{assign var='_title' value='въведи нов ПКО'}
{else}
	{assign var='_title' value='корегирай ПКО '|cat:$PRIHNUMB}
{/if}
...
<br>
<input type="text" name="pass" id="pass" size=100 {include file="_erelem.tpl" ID="pass" C1="input" C2="inputer"}> 
	<br>
	представител на
<br>

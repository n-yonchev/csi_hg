<?php /* Smarty version 2.6.9, created on 2020-02-27 15:08:56
         compiled from cazonotemodi.ajax.tpl */ ?>
...
<?php if ($this->_tpl_vars['EDIT'] <= 0): ?>
	<?php $this->assign('_title', 'ВЪВЕДИ бележки');  else: ?>
	<?php $this->assign('_title', 'корегирай бележките');  endif;  $_smarty_tpl_vars = $this->_tpl_vars;

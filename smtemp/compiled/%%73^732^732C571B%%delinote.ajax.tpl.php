<?php /* Smarty version 2.6.9, created on 2025-09-05 16:02:14
         compiled from delinote.ajax.tpl */ ?>
...
<?php if ($this->_tpl_vars['EDIT'] == 0): ?>
	<?php $this->assign('_title', 'въведи нови бележки'); ?>
<?php else: ?>
	<?php $this->assign('_title', 'корегирай бележки'); ?>
<?php endif; ?>
<?php $_smarty_tpl_vars = $this->_tpl_vars;
...
текст
<br>
<textarea rows=4 cols=70 name="notes" id="notes" size=255 <?php $_smarty_tpl_vars = $this->_tpl_vars;

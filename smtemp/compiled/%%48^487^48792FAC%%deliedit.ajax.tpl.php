<?php /* Smarty version 2.6.9, created on 2020-02-28 11:17:24
         compiled from deliedit.ajax.tpl */ ?>
...
unset($_smarty_tpl_vars);
 ?>
<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "_window.header.tpl", 'smarty_include_vars' => array('TITLE' => "корегирай екземпляр")));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
<?php $_smarty_tpl_vars = $this->_tpl_vars;
...
адресат
<br>
<input type="text" name="adresat" id="adresat" size=80 <?php $_smarty_tpl_vars = $this->_tpl_vars;

<?php /* Smarty version 2.6.9, created on 2020-03-04 10:19:07
         compiled from fiusform.tpl */ ?>
<table class="d_table" width='350px' cellspacing='0' cellpadding='0' align=center>
<thead>
	<tr>
	<td class='d_table_title' colspan='200'>брой дела по деловодители и години</td>
	</tr>
</thead>
...
?>
	...
	<tr onmouseover='this.className="tr_hover";' onmouseout='this.className="";' >
		<td> <font color="red"> СВОДОБНИ </font></td>
			<?php else: ?>
	<tr onmouseover='this.className="tr_hover";' onmouseout='this.className="";' >
...
?>
	<?php $this->assign('councase', $this->_tpl_vars['ARCOUN'][$this->_tpl_vars['cuuser']][$this->_tpl_vars['year']]); ?>
		<td align=center 
<?php if ($this->_tpl_vars['councase'] == 0):  else: ?>bgcolor="#dddddd" style="cursor:pointer" onclick="document.location.href='<?php echo $this->_tpl_vars['elem'][$this->_tpl_vars['year']]['view']; ?>
';" title="виж делата"<?php endif; ?>>

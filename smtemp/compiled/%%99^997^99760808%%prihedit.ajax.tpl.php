...
<?php if ($this->_tpl_vars['EDIT'] == 0): ?>
	<?php $this->assign('_title', 'въведи нов ПКО'); ?>
<?php else: ?>
	<?php $this->assign('_title', ((is_array($_tmp='корегирай ПКО ')) ? $this->_run_mod_handler('cat', true, $_tmp, $this->_tpl_vars['PRIHNUMB']) : smarty_modifier_cat($_tmp, $this->_tpl_vars['PRIHNUMB']))); ?>
<?php endif; ?>
<?php $_smarty_tpl_vars = $this->_tpl_vars;

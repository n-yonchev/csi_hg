<?php /* Smarty version 2.6.9, created on 2020-03-17 09:01:42
         compiled from newc.ajax.tpl */ ?>
...
unset($_smarty_tpl_vars);
 ?>
			<?php if ($this->_tpl_vars['EDIT'] == 0): ?>
				<?php $this->assign('txti', "добави ново дело"); ?>
			<?php else: ?>
				<?php $this->assign('txti', "корегирай за дело"); ?>
...
<td>
<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "_select.tpl", 'smarty_include_vars' => array('FROM' => $this->_tpl_vars['ARYEARNAME'],'ID' => 'year','C1' => 'input','C2' => 'inputer')));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
<td>

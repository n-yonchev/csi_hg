<?php /* Smarty version 2.6.9, created on 2021-03-09 16:21:36
         compiled from cofromedit.ajax.tpl */ ?>
<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "_ajax.header.tpl", 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
  if ($this->_tpl_vars['EDIT'] == 0): ?>
	<?php $this->assign('_title', 'въведи нов елемент идва от');  else: ?>
	<?php $this->assign('_title', 'КОРЕГИРАЙ');  endif;  $_smarty_tpl_vars = $this->_tpl_vars;

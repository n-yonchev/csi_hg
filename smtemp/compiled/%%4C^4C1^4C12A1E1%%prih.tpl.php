<?php /* Smarty version 2.6.9, created on 2020-03-31 22:21:08
         compiled from prih.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'tomoex', 'prih.tpl', 53, false),array('modifier', 'tomoney2', 'prih.tpl', 55, false),array('modifier', 'date_format', 'prih.tpl', 58, false),)), $this); ?>
...
.dateinvo {font:normal 7pt verdana;border:0px solid black; color:black;}
		...
		<tr class='head1'>
<td colspan='200'> списък приходни касови ордери <?php echo $this->_tpl_vars['TEXTHEAD']; ?>
...
" class="nyroModal addnew" target="_blank">добави ПКО</a>
						<?php endif; ?>
		<tr class='head2'>
<td align=right> сума
<td> дата
...
<td> <?php echo $this->_tpl_vars['elem']['cashuser']; ?>
						...
						<?php else: ?>
<td align=center>
				<?php if ($this->_tpl_vars['elem']['typesuma'] == 3): ?>
...
<script>
function dele(link){
	if(confirm('потвърди изтриването на ПКО')) window.location.href=link;
}
</script>

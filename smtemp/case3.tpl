{*----
		23.07.2010 - специфичен шаблон за /търси дело /филтър дела 
		клонинг на case.tpl 
		отпадат колоните : 
			последна промяна 
			входящи документи 
...
<td {$tdst}> {$elem.username} &nbsp;</td>
				<td class='sep'>&nbsp;</td>
<td {$tdst}> {include file="case3list.tpl" LIST=$elem.listclai}</td>
				<td class='sep'>&nbsp;</td>
<td {$tdst}> {include file="case3list.tpl" LIST=$elem.listdebt}</td>
{*--------*}
				<td class='sep'>&nbsp;</td>
<td {$tdst} align=center>
<nobr>

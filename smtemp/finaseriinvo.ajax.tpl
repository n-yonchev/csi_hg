...
<td> дата фактура
<td> 
<input type="text" name="dateinvo" id="dateinvo" size=18 {include file="_erelem.tpl" ID="dateinvo" C1="input" C2="inputer"}>
...
<br>
<input type="checkbox" name="seriinvoconf" label="потвърди желания номер на фактурата {$smarty.post.seriinvo}">
									{else}
									{/if}
{*
		<tr>

...
{else}
	{assign var='_title' value='корегирай тип'}
{/if}
...
дни за отговор
<br>
<input type="text" name="deadline_days" id="days_limit" size=2 {include file="_erelem.tpl" ID="deadline_days" C1="input" C2="inputer"}>
<br>

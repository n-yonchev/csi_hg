...
<td align=left>
{include file="_select.tpl" FROM=$ARTYPENAME ID="e1type" C1="input7"}
<td align=left>
{include file="_select.tpl" FROM=$ARDIRENAME ID="e1dire" C1="input7"}
<td align=left>
{include file="_select.tpl" FROM=$ARUSERNAME ID="e1user" C1="input7"}
<td align=left>
{include file="_select.tpl" FROM=$ARSEPANAME ID="e1sepa" C1="input7"}
<td align=left>
{include file="_select.tpl" FROM=$ARCLOSNAME ID="e1clos" C1="input7"}
<td align=left>
{include file="_select.tpl" FROM=$ARBACKNAME ID="e1back" C1="input7"}
<td align=left>

<?php
# демаркиране на разпределение като приключено (преведено) 
# отгоре : 
#    $GETPARAM - масив с параметрите от GET 
#    $mode - текущия режим 
#    $page - текущата страница 
# още отгоре : 
#    $unmark - finatran.id за демаркиране 
//print_r($GETPARAM);

# таблицата 
$taname= "finatran";
# шаблона 
$tpname= "tranunmark.ajax.tpl";
# полетата 
$filist= array();
# константни полета 
$ficonst= array();
...
//print "MFACPROC=[$mfacproc]";
									# основен параметър - 
									# $unmark - $taname.id - id за демаркиране 
if (0){
...
//	$DB->query("update $taname set isdone=1 where id=?" ,$mark);
	$DB->query("update $taname set idstat=0, statmodi=now() where id=?" ,$unmark);

...
# отгоре : 
#     $finaprin = finance.id - записа за отпечатване 
...
//print "[$func][$idel]";
# четем записа 
$rofina= getrow("finance",$finaprin);
...
$mytext= "вноска по изпълнително дело ".$fullnumb;
...
print smdisp("cazofinaprin.ajax.tpl","iconv");
//print $mycont;
****/
...
body, td {font-family:verdana; font-size:8pt;}
	...
	";
ExcelHeader("ПКОпостъп-".$rofina["cashserial"]."-".$rofina["cashyear"].".doc");
	$outp= "
<html>
<head>

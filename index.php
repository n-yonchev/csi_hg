...
# 31.01.2012 - добавяме права връчване 
$listperm[5]= "връчване";
							$ISPOST= true;
...
//			"smet",
# 09.08.2011 - статистика бройки - Бъзински 
			"presen",
# 20.05.2014 - регистър-2014 параметри 
			"regi14",
"etlist",
//			"pere"
			"pere_2",
...
++++++++++*/
		# за ЦРД-2014 
$mainmenu["regi14"]["text"]= "ЦРД-2014";	$mainmenu["regi14"]["php"]= "regi14.php";
$mainmenu["etlist"]["text"]= "дела с ЕТ";	$mainmenu["etlist"]["php"]= "etlist.php";
//# 22.11.2010 - редове за сметка 
//$mainmenu["smet"]["text"]= "сметка редове";		$mainmenu["smet"]["php"]= "smet.php";
$mainmenu["pere"]["text"]= "п1";	$mainmenu["pere"]["php"]= "pere.php";
$mainmenu["pere_2"]["text"]= "перемиране";	$mainmenu["pere_2"]["php"]= "pere_2.php";
$mainmenu["issilog"]["text"]= "ИССИ логове";	$mainmenu["issilog"]["php"]= "issi_log.php";
$mainmenu["epepsubject"]["text"]= "Ел партида типове - предмет";	$mainmenu["epepsubject"]["php"]= "epep_subject.php";
$mainmenu["printers_refresh"]["text"]= "QR принтери";		$mainmenu["printers_refresh"]["php"]= "printers_refresh.php";
				}else{
				}
# 13.07.2010 - наблюдатели 
# 11.05.2011 Дичев - достъп за всички 
$mainmenu["v1"]["text"]= "наблюдатели";		$mainmenu["v1"]["php"]= "v1.php";
$mainmenu["presen"]["text"]= "представяне";		$mainmenu["presen"]["php"]= "presen.php";
...
$mainmenu["reports"]["text"]= "годишни отчети";			$mainmenu["reports"]["php"]= "reports.php";
# 28.11.2023 ridirect към statis.php
$mainmenu["statis"]["text"] = "статистика";		$mainmenu["statis"]["php"]= "";
...
$mainmenu["etuser"]["text"]= "дела с ЕТ";		$mainmenu["etuser"]["php"]= "etuser.php";
/*++++++++++
...
$mainmenu["cer2"]["text"]= "справки от ЦРД";			$mainmenu["cer2"]["php"]= "cer2.php";
++++++++++*/
		}
...
*/
# 24.09.2014 - фактури 
$mainmenu["finainvo"]["text"]= "фактури";			$mainmenu["finainvo"]["php"]= "finainvo.php";
$mainmenu["finai2"]["text"]= "фактури суми";		$mainmenu["finai2"]["php"]= "finai2.php";
$mainmenu["kasa"]["text"]= "каса";		$mainmenu["kasa"]["php"]= "kasa.php";
$mainmenu["prih"]["text"]= "- ПКО";		$mainmenu["prih"]["php"]= "prih.php";
$mainmenu["razh"]["text"]= "- РКО";		$mainmenu["razh"]["php"]= "razh.php";
		}
# 18.08.2014 - връчване 
		if (array_search(5,$arperm)===false){
		}else{
$mainmenu["deli"]["text"]= "документи";				$mainmenu["deli"]["php"]= "deli.php";
//$mainmenu["deli2"]["text"]= "д2";					$mainmenu["deli2"]["php"]= "deli2.php";
//$mainmenu["deliuser"]["text"]= "призовкари";		$mainmenu["deliuser"]["php"]= "deliuser.php";
$mainmenu["delistat"]["text"]= "статуси призовки";	$mainmenu["delistat"]["php"]= "delistat.php";
$mainmenu["delistat2"]["text"]= "статуси поща";		$mainmenu["delistat2"]["php"]= "delistat2.php";
$mainmenu["delistat3"]["text"]= "статуси куриер";		$mainmenu["delistat3"]["php"]= "delistat3.php";
$mainmenu["delistat4"]["text"]= "статуси email";		$mainmenu["delistat4"]["php"]= "delistat4.php";
$mainmenu["delisour"]["text"]= "външни източници";	$mainmenu["delisour"]["php"]= "delisour.php";
//$mainmenu["delitota"]["text"]= "статистика";		$mainmenu["delitota"]["php"]= "delitota.php";
		}
# 9.12.2019 - пакетни преводи чрез XML файл 
$mainmenu["trango"]["text"]= "готови за превод";	$mainmenu["trango"]["php"]= "trango.php";
$mainmenu["tran"]["text"]= "преводи";				$mainmenu["tran"]["php"]= "tran.php";
$mainmenu["tranac"]["text"]= "специални сметки";	$mainmenu["tranac"]["php"]= "tranac.php";

//$mode= $_REQUEST["mode"];
//$mode= isset($mode) ? $mode : ${$ak=array_keys($mainmenu)}[0];
					
					# 26.05.2014 грешки от ЦРД-2014 
					$mainmenu["reg4usermess1"]["php"]= "reg4usermess1.php";
					$mainmenu["reg4usermess2"]["php"]= "reg4usermess2.php";
					$mainmenu["reg4messall"]["php"]= "reg4messall.php";

$mainmenu["docudeadlines"]["php"]= "docudeadlines.php";
...
foreach($mainmenu as $inmenu=>$elmenu){
	...
	/* 
		28.11.2023
		предефиниране на мод "statis" - препращане към statis.php
	*/
	if($inmenu == "statis") {
		$mainmenu[$inmenu]["link"] = "statis.php";
	}
//print "<br>$aaa";
}
...
$count_docudeadlines = $DB->selectCell("	select
		COUNT(docu.id)
	...
	where
	    ...
	    AND datediff(date_add(docu.created, INTERVAL dt.deadline_days DAY), NOW()) >= 0
");
$smarty->assign("DOCUDEADLINES_COUNT", $count_docudeadlines);
$smarty->assign("DOCUDEADLINES_LINK", geturl("mode=docudeadlines&type=active"));
# 30.03.2010
...
$smarty->assign("EVENLINK", "calecoming.ajax.php".geturl("dat1=".$dat1."&dat2=".$dat2));
					...
					# 26.05.2014 грешки от ЦРД-2014 
					$reg4coun1= $DB->selectCell("
						select count(distinct reg4mess.idcase)
						from reg4mess 
...
$smarty->assign("REG4USERCOUN1", $reg4coun1);
$smarty->assign("REG4USERLINK1", geturl("mode=reg4usermess1"));
					}
			if ($logisadmin){
					$reg4counall= $DB->selectCell("
						select count(distinct reg4mess.idcase)
						from reg4mess 
						");
					if (empty($reg4counall)){
					}else{
$smarty->assign("REG4COUNALL", $reg4counall);
$smarty->assign("REG4LINKALL", geturl("mode=reg4messall"));
					}
					# 16.12.2014 - евент.грешки при обръщение 
					$arreg4= $DB->select("
						select *
						from reg4call 
						...
						order by time desc
						");
//						where date_sub(now(), interval 1 day)>=time and substr(texter,1,3)='ERR'
					$arreg4= dbconv($arreg4);
//print_ru($arreg4);
									$iser= false;
					foreach($arreg4 as $elem){
						if (substr($elem["texter"],0,3)=="ERR"){
									$iser= true;
									break;
						}else{
						}
					...
					if ($iser){
$smarty->assign("ARREG4", $arreg4);
					}else{
					}
			}else{
			}
////var_dump($iduser,$reg4coun,$reg4coun2);

<?php
# маркиране на разпределение като приключено (преведено) 
# отгоре : 
...
//print "MFACPROC=[$mfacproc]";
									# основен параметър - 
									# $mark - $taname.id - id за маркиране 
if (0){
...
//	$DB->query("update $taname set isdone=1 where id=?" ,$mark);
	$DB->query("update $taname set idstat=9, statmodi=now() where id=?" ,$mark);

...
$taname= "banklist";
# шаблона 
$tpname= "bankedit.ajax.tpl";
# полетата 
$filist= array(
	"name"=>  array("validator"=>"notempty", "error"=>"името не може да е празно"),
	//"address" =>  array("validator"=>"notempty", "error"=>"адрес не може да е празно"),
	"bic" =>  array("validator"=>"notempty", "error"=>"BIC код не може да е празно")
//	,"address"=> NULL
);
# константни полета 
